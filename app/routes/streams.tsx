...
export const loader: LoaderFunction = async ({ request }: LoaderArgs) => {
    ...
    //     throw e; // TODO: HANDLE ERROR BETTER
    // }
    ...
    if (oauth_token && oauth_verifier && oauth_token_secret) {
        ...
        let accessTokenPerm = null;
        let accessSecretPerm = null;

        console.log("RUNNING LOGIN");
        api.login(oauth_verifier)
            .then(({ client: loggedClient, accessToken, accessSecret }) => {
                console.log("I'M IN THE THEN PART");
                api = loggedClient
                console.log(loggedClient.currentUser());
                accessTokenPerm = accessToken;
                accessSecretPerm = accessSecret;
        ...
        api = new TwitterApi({
            appKey: process.env.consumer_key,
            appSecret: process.env.consumer_secret,
            accessToken: accessTokenPerm,
            accessSecret: accessSecretPerm,
        });
